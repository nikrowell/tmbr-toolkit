...
export default class Texture {
  ...
  constructor(gl, image, wrapS, wrapT, filter, flipY) {
    ...
    if ((image.complete && image.width && image.height) || !(image instanceof Image)) {
      this.update();
    } else {
  ...
  update() {
    ...
    gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, this.flipY === true);
    ...
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, this.filter || gl.LINEAR);
  }
